...
<title>Download - TrustShield VPN</title>
...
<h3>Windows App</h3>
<p>Download the TrustShield VPN client for Windows 10/11.</p>
<a class="vpn-buy" href="#">Download</a>
</div>
<div class="vpn-feature">
<div class="vpn-feature-icon"><i class="fab fa-apple"></i></div>
<h3>macOS App</h3>
<p>Download the TrustShield VPN client for Intel and Apple Silicon.</p>
<a class="vpn-buy" href="#">Download</a>
</div>
<div class="vpn-feature">
<div class="vpn-feature-icon"><i class="fab fa-android"></i></div>
<h3>Android App</h3>
<p>Install TrustShield VPN for Android phones and tablets.</p>
<a class="vpn-buy" href="#">Download</a>
</div>
<div class="vpn-feature">
<div class="vpn-feature-icon"><i class="fab fa-apple"></i></div>
<h3>iOS App</h3>
<p>Install TrustShield VPN on iPhone and iPad.</p>
<a class="vpn-buy" href="#">Download</a>
</div>
<div class="vpn-feature">
